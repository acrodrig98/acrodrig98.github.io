...
## The SDSS Selection Bias Problem

XGBoost's strong numbers masked a real problem. When we looked at where the model placed its positive predictions on the Hertzsprung-Russell diagram, the distribution looked wrong. White dwarfs were being flagged as emitters. Too many mid-to-lower main sequence stars appeared in the positive class. Physically, genuine H-alpha emitters should concentrate at the upper main sequence — younger, more active, or in mass-transferring systems.

The root cause was SDSS targeting bias. SDSS didn't observe a random sample of the sky. Its spectroscopic follow-up prioritized galaxies, quasars, and specific stellar populations. The H-alpha emitters in our training set reflect that history. More critically, the *negatives* — stars we labeled as non-emitters — were not a fair sample of the quiescent stellar population. The classifier had never seen enough boring, unremarkable field stars to learn what not emitting really looks like across the full stellar parameter space.
